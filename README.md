...
spectra config <path|list|get|set|unset|reset|edit>  # manages the global user config (~/Library/Application Support/openspec/config.yaml on macOS, $XDG_CONFIG_HOME/openspec/config.yaml elsewhere); needs no project
```
